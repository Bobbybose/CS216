...
char FinalGrade::decideLetterGrade() const
{
    ...
    if(score>=90)                       //If the score is above a 90
        return 'A';                         //It's an A
    if(score>=80)                       //If the score is above an 80 and below a 90
        return 'B';                         //It's a B
    if(score>=70)                       //If the score is above a 70 and below an 80
        return 'C';                         //It's a C
    if(score>=60)                       //If the score is above a 60 and below a 70    
        return 'D';                         //It's a D
